...
class UpdateTerritoryUser
{
	...
	public static function updateTerritoryuser($user, $territory)
	{
		$territoryUsersOperations = new TerritoryUsersOperations();
		$response = $territoryUsersOperations->updateTerritoryUser($user, $territory);
		if ($response != null) {
...
UpdateTerritoryUser::updateTerritoryuser($user, $territory);
