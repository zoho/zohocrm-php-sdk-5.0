        ...
        if ($response != null) {
            ...
            if ($responseHandler instanceof ResponseWrapper) {
                ...
                foreach ($wizards as $wizard) {
                    echo ("Wizard CreatedTime: ");
                    print_r($wizard->getCreatedTime());
                    echo ("\n");
                    echo ("Wizard ModifiedTime: ");
                    print_r($wizard->getModifiedTime());
                    echo ("\n");
                            ...
                            if ($chartData != null) {
                                ...
                                if ($nodes != null) {
                                    foreach ($nodes as $node) {
                                        ...
                                        echo ("Wizard Container ChartData Node StartNode: ");
                                        print_r($node->getStartNode());
                                        echo ("\n");
