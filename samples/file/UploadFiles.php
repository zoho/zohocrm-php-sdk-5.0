...
class UploadFiles
{
    ...
    public static function uploadFiles()
    {
        ...
        $streamWrapper = new StreamWrapper(null, null, "/SampleApp/file/download.png");
        $streamWrapper1 = new StreamWrapper(null, null, "/SampleApp/file/download.png");
        $streamWrapper2 = new StreamWrapper(null, null, "/SampleApp/file/download.png");
