...
class GetRelatedRecord
{
    ...
    public static function getRelatedRecord(string $moduleAPIName, string $recordId, string $relatedListAPIName, string $relatedListId, string $destinationFolder)
    {
        ...
        $response = $relatedRecordsOperations->getRelatedRecord($relatedListId, $recordId, $paramInstance, $headerInstance);
        if ($response != null) {
...
$relatedListId = "440248001055023";
$destinationFolder = "/PHP/sdk-sample-application/file";
GetRelatedRecord::initialize();
GetRelatedRecord::getRelatedRecord($moduleAPIName,$recordId,$relatedListAPIName,$relatedListId,$destinationFolder);
