...
class TransferAndDeleteTerritories
{
	...
	public static function transferAndDeleteTerritories()
	{
		...
		$response = $territoriesOperations->transferAndDeleteTerritories($request);
		if ($response != null) {
...
TransferAndDeleteTerritories::transferAndDeleteTerritories();