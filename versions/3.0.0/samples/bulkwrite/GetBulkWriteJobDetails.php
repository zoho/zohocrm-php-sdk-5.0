                    ...
                    foreach ($resources as $resource) {
                        ...
                        if ($fieldMappings != null) {
                            foreach ($fieldMappings as $fieldMapping) {
                                ...
                                echo ("Bulkwrite Resource FieldMapping Index: ");
                                print_r($fieldMapping->getIndex());
                                echo ("\n");
                                ...
                                if ($fieldMapping->getModule() != null) {
                                    echo ("Bulkwrite Resource FieldMapping Module: ");
                                    print_r($fieldMapping->getModule());
                                    echo ("\n");
                                }
