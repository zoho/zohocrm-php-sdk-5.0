...
class GetTerritoryUser
{
	...
	public static function getTerritoryUser($user, $territory)
	{
		$territoryUsersOperations = new TerritoryUsersOperations();
		$response = $territoryUsersOperations->getTerritoryUser($user, $territory);
		if ($response != null) {
...
GetTerritoryUser::getTerritoryUser($user, $territory);
