...
class CreateRecords
{
    ...
    public static function createRecords(string $moduleAPIName)
    {
        ...
        */
        ...
        $record = new Record();
        $record->addKeyValue("id", "4402481099117");
        ...
        $imageUpload->setFileIdS("ae9c7cefa418aec1d6a5cc2d9ab35c320c7da49c4222acd283e275ffade3f0ff");
        $record1->addKeyValue("Image_Upload", [$imageUpload]);
        
        $fileDetails = array();
        $fileDetail1 = new FileDetails();
        $fileDetail1->setFileIdS("ae9c7cefa418aec1d6a5cc2d9ab35c32b3ec27aa98b6161a4df6e2c0dc1f0f80");
        array_push($fileDetails, $fileDetail1);
        $fileDetail2 = new FileDetails();
        $fileDetail2->setFileIdS("ae9c7cefa418aec1d6a5cc2d9ab35c328db2d16efac6afe745678b577297a3b3");
        array_push($fileDetails, $fileDetail2);
        $fileDetail3 = new FileDetails();
        $fileDetail3->setFileIdS("ae9c7cefa418aec1d6a5cc2d9ab35c3207c8e1a4448a63b609f1ba7bd4aee6eb");
        ...
        $contactName->addFieldValue(Contacts::id(), "347706111383004");
        ...
        $participant2->addKeyValue("participant", "347706119031");
