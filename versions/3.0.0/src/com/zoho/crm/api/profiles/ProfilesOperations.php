...
class ProfilesOperations
{
	...
	public  function getProfiles(ParameterMap $paramInstance=null)
	{
		...
		$apiPath=""; 
		$apiPath=$apiPath.('/crm/v5/settings/profiles'); 
	 ...
	 * @param ProfileWrapper $request An instance of ProfileWrapper
	 * @return APIResponse An instance of APIResponse
	 */
	public  function cloneProfiles(string $id, ProfileWrapper $request)
	{
		$handlerInstance=new CommonAPIHandler(); 
		$apiPath=""; 
		$apiPath=$apiPath.('/crm/v5/settings/profiles/'); 
	 ...
	 * @return APIResponse An instance of APIResponse
	 */
	public  function updateProfile(string $id, ProfileWrapper $request)
	{
		$handlerInstance=new CommonAPIHandler(); 
		$apiPath=""; 
		$apiPath=$apiPath.('/crm/v5/settings/profiles/'); 
