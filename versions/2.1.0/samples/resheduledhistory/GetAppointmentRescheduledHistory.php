...
use com\zoho\crm\api\reschedulehistory\GetAppointmentRescheduledHistoryParam;
...
class GetAppointmentRescheduledHistory
{
    ...
    public static function getAppointmentRescheduledHistory($id)
    {
        $rescheduleHistoryOperations = new RescheduleHistoryOperations();
        $paraminstnance = new ParameterMap();
        $paraminstnance->add(GetAppointmentRescheduledHistoryParam::fields(), "Rescheduled_From");
        $response = $rescheduleHistoryOperations->getAppointmentsRescheduledHistory($id , $paraminstnance);
        if ($response != null) {
...
GetAppointmentRescheduledHistory::getAppointmentRescheduledHistory($id);