...
use com\zoho\crm\api\usersunavailability\UsersUnavailability;
...
class CreateUsersUnavailability
{
    ...
    public static function createUsersUnavailability()
    {
        ...
        $userList = [];
        $user1 = new UsersUnavailability();
        $user1->setComments("Unavailable");
        $from = date_create("2022-06-30T15:10:00");
        $user1->setFrom($from);
        $to = date_create("2022-06-30T15:10:00");
        $user1->setTo($to);
        $user = new User();
