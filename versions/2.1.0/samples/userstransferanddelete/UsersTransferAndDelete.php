...
class UsersTransferAndDelete 
{
	...
	public static function usersTransferAndDelete()
	{
		...
		$transferAndDelete->setId("329874712124");
		...
		$response = $usersTransferDeleteOperations->usersTransferAndDelete($request);
		if ($response != null) {
...
UsersTransferAndDelete::usersTransferAndDelete();
