...
class TerritoriesOperations
{
	...
	public  function getTerritories(ParameterMap $paramInstance=null)
	{
		...
		$apiPath=""; 
		$apiPath=$apiPath.('/crm/v5/settings/territories'); 
	...
	public  function getAssociatedUserCount()
	{
		$handlerInstance=new CommonAPIHandler(); 
		$apiPath=""; 
		$apiPath=$apiPath.('/crm/v5/settings/territories/actions/associated_users_count'); 
		$handlerInstance->setAPIPath($apiPath); 
		$handlerInstance->setHttpMethod(Constants::REQUEST_METHOD_GET); 
		$handlerInstance->setCategoryMethod(Constants::REQUEST_CATEGORY_ACTION); 
		return $handlerInstance->apiCall(ResponseHandler::class, 'application/json'); 
	...
	public  function transferAndDeleteTerritories(TransferBodyWrapper $request)
	{
		$handlerInstance=new CommonAPIHandler(); 
		$apiPath=""; 
		$apiPath=$apiPath.('/crm/v5/settings/territories/actions/transfer_and_delete'); 
		$handlerInstance->setAPIPath($apiPath); 
		$handlerInstance->setHttpMethod(Constants::REQUEST_METHOD_POST); 
		$handlerInstance->setCategoryMethod(Constants::REQUEST_METHOD_DELETE); 
		$handlerInstance->setContentType('application/json'); 
