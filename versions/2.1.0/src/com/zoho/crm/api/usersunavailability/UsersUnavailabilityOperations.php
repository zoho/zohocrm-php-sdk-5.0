...
class UsersUnavailabilityOperations
{
	...
	public  function createUsersUnavailability(BodyWrapper $request)
	{
		...
		$apiPath=""; 
		$apiPath=$apiPath.('/crm/v5/settings/users_unavailability'); 
	 ...
	 * @return APIResponse An instance of APIResponse
	 */
	public  function updateUsersUnavailabilites(BodyWrapper $request)
	{
		$handlerInstance=new CommonAPIHandler(); 
		$apiPath=""; 
		$apiPath=$apiPath.('/crm/v5/settings/users_unavailability'); 
	 ...
	 * @return APIResponse An instance of APIResponse
	 */
	public  function deleteUserUnavailabilityHour(string $id)
	{
		$handlerInstance=new CommonAPIHandler(); 
		$apiPath=""; 
		$apiPath=$apiPath.('/crm/v5/settings/users_unavailability/'); 
