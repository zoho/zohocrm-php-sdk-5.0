...
class UpdatePortal
{
    ...
    public static function updatePortal(String $portalName)
    {
        ...
        $response = $portalsOperations->updatePortal($portalName, $bodyWrapper);
        if ($response != null) {
...
UpdatePortal::updatePortal($portalName);