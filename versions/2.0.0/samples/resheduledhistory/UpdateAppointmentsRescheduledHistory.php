...
class UpdateAppointmentsRescheduledHistory
{
    ...
    public static function updateAppointmentsRescheduledHistory()
    {
        ...
        $response = $rescheduleHistoryOperations->updateAppointmentsRescheduledHistory($request);
        if ($response != null) {
...
UpdateAppointmentsRescheduledHistory::updateAppointmentsRescheduledHistory();