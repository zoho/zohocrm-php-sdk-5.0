...
class Constants
{
    ...
    const GET_TOKEN_FILE_ERROR1 = "Exception in FileStore : Given user authentication details not found.";
    ...
    const GET_TOKEN_DB_ERROR1 = "Exception in DBStore : Given user authentication details not found.";
    ...
    const SET_CONTENT_TYPE_HEADER = array("/crm/bulk/v5/read", "/crm/bulk/v5/write");

    const DATA_TYPE = array("List" => "array", "Boolean" => "boolean", "Long" => "string", "HashMap" => "array", "array" => "Map", "Map" => "array", "Float" => "double", "Date"=>"DateTime", "TimeZone"=>"DateTimeZone");
