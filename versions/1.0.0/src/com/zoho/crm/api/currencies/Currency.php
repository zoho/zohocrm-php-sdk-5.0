...
class Currency implements Model
{
	 ...
	 * @return CurrencyFormat An instance of CurrencyFormat
	 */
	 ...
	 * @param CurrencyFormat $format An instance of CurrencyFormat
	 */
	public  function setFormat(CurrencyFormat $format)
	{
		$this->format=$format; 
