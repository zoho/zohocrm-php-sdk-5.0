...
class OAuthToken implements Token
{
    ...
    public function processResponse($oauthToken, $response)
    {
        ...
        {
            $oauthToken->refreshToken = $jsonResponse[Constants::REFRESH_TOKEN];
        }
     ...
     */
    public function __construct($clientID, $clientSecret, $grantToken, $refreshToken, $redirectURL=null, $id=null, $accessToken=null, $userSignature=null)
    {
        $this->clientID = $clientID;
