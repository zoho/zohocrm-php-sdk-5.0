...
class UpdateCalls
{
    ...
    public static function updatecalls($moduleAPIName)
    {
        ...
        $records = array();
        $record1 = new Record();
        $record1->setId("347706111224001");
        // Schedule a call
        $whoId = new Record();
        $whoId->setId("347706118585001");
        $record1->addFieldValue(Calls::WhoId(), $whoId);
        $whatId = new Record();
        $whatId->setId("347706118911");
        ...
        // log a call
        // $whoId1 = new Record();
        // $whoId1->setId("300432434234434456");
        // $record1->addFieldValue(Calls::WhoId(), $whoId1);
        // $whatId1 = new Record();
        // $whatId1->setId("325456023230");
