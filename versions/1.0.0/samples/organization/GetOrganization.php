            ...
            if ($responseHandler instanceof ResponseWrapper) {
                ...
                foreach ($orgs as $org) {
                    ...
                    if ($hierarchyPreferences != null) {
                        echo ("Organization HierarchyPreferences Type: " . $hierarchyPreferences->getType()->getValue() . "\n");
                    }
                    ...
                    echo ("Organization McStatus: ");
                    print_r($org->getMcStatus());
                    echo ("\n");
                    echo ("Organization GappsEnabled: ");
                    print_r($org->getGappsEnabled());
                    echo ("\n");
                    echo ("Organization DomainName: " . $org->getDomainName() . "\n");
                    echo ("Organization TranslationEnabled: ");
                    print_r($org->getTranslationEnabled());
                    echo ("\n");
                    ...
                    if ($licenseDetails != null) {
                        ...
                        echo ("Organization LicenseDetails Paid: ");
                        print_r($licenseDetails->getPaid());
                        echo ("\n");
                    ...
                    echo ("Organization PrivacySettings: ");
                    print_r($org->getPrivacySettings());
                    echo ("\n");
                    echo ("Organization PrimaryEmail: " . $org->getPrimaryEmail() . "\n");
                    echo ("Organization HipaaComplianceEnabled: ");
                    print_r($org->getHipaaComplianceEnabled());
                    echo ("\n");
