...
class GetAssignmentRule
{
    ...
    public static function getAssignmentRule(string $ruleId, string $moduleAPIName)
    {
        $paramInstance = new ParameterMap();
        $paramInstance->add(GetAssignmentRuleParam::module(), $moduleAPIName);
...
$ruleId = 440248001305001;
$moduleAPIName = "leads";
GetAssignmentRule::initialize();
GetAssignmentRule::getAssignmentRule($ruleId,$moduleAPIName);