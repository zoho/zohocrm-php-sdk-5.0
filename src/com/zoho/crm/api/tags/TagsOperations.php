...
class TagsOperations
{
	...
	public  function getTags(ParameterMap $paramInstance=null)
	{
		...
		$apiPath=""; 
		$apiPath=$apiPath.('/crm/v5/settings/tags'); 
	 ...
	 * @return APIResponse An instance of APIResponse
	 */
	public  function addTags(string $recordId, string $module, NewTagRequestWrapper $request, ParameterMap $paramInstance=null)
	{
		$handlerInstance=new CommonAPIHandler(); 
		$apiPath=""; 
	 ...
	 * @return APIResponse An instance of APIResponse
	 */
	public  function removeTags(string $recordId, string $module, ExistingTagRequestWrapper $request)
	{
		$handlerInstance=new CommonAPIHandler(); 
		$apiPath=""; 
		$apiPath=$apiPath.('/crm/v5/'); 
	 ...
	 * @return APIResponse An instance of APIResponse
	 */
	public  function addTagsToMultipleRecords(string $module, NewTagRequestWrapper $request, ParameterMap $paramInstance=null)
	{
		$handlerInstance=new CommonAPIHandler(); 
		$apiPath=""; 
		$apiPath=$apiPath.('/crm/v5/'); 
	 ...
	 * @return APIResponse An instance of APIResponse
	 */
	public  function removeTagsFromMultipleRecords(string $module, ExistingTagRequestWrapper $request, ParameterMap $paramInstance=null)
	{
		$handlerInstance=new CommonAPIHandler(); 
		$apiPath=""; 
		$apiPath=$apiPath.('/crm/v5/'); 
