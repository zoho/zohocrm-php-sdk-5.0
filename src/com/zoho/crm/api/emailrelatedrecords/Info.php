...
class Info implements Model
{
	 ...
	 * @return int A int representing the nextIndex
	 */
	 ...
	 * @return int A int representing the prevIndex
	 */
	 ...
	 * @param int $prevIndex A int
	 */
	public  function setPrevIndex(int $prevIndex)
	{
