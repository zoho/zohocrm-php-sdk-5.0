...
class ModuleFields extends Fields implements Model
{
	 ...
	 * @return ModuleFieldLookup An instance of ModuleFieldLookup
	 */
	 ...
	 * @param ModuleFieldLookup $lookup An instance of ModuleFieldLookup
	 */
	public  function setLookup(ModuleFieldLookup $lookup)
	{
		$this->lookup=$lookup; 
